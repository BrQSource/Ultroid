...
TLINK = INLINE_PIC or "https://telegra.ph/file/4c59af3b7f9a08c78a04e.jpg"
...
SUP_BUTTONS = [
    [
        Button.url("• Java", url="t.me/jai6h"),
        Button.url("• Zeno", url="http://T.me/Zeoonn1"),
    ],
]
...
async def inline_alive(o):
    ...
    WEB0 = InputWebDocument(
        "https://telegra.ph/file/1c6aba6af7aba3e02f1d3.jpg", 0, "image/jpg", []
    )
    RES = [
